...
def parse_args(parse=True, **optional_kwargs):
    ...
    # Checkpoint
    parser.add_argument('--output', type=str, default='/home/data2/liqingyuan/snap/test')
    ...
    parser.add_argument('--data_prefix', type=str, default="2015")
    ...
    parser.add_argument('--vis_lr', type=float, default=1e-5)
    ...
    parser.add_argument('--prompt', type=str, default="spot ")
