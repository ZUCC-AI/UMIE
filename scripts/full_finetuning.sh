...
python -m torch.distributed.launch \
     ...
     src/${task}.py \
      --distributed \
        ...
        --gen_max_length 128 \
        --use_tasks_prompts \
        --tasks "event_ace05_arg, event_ace05_trigger,event_swig_arg, event_swig_trigger, mner_mner2015, mner_mnersnap, relation_mnre_v2, relation_mnre_v1" \
        --eval_tasks "event_m2e2_arg, event_m2e2_trigger, event_m2e2_two_stage, mner_mner2015, mner_mnersnap, mner_mner2017, relation_mnre_v2, relation_mnre_v1" \
