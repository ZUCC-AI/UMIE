...
python -m torch.distributed.launch \
      ...
      --distributed --multiGPU \
        ...
        --lr ${lr} \
        --epochs 1\
        --load /home/liqingyuan/models/flan-t5_ie_multitask/T5_UIE_TEST_MUTAL_ENTITY_20230806225144_32-1e-4-hf_models/flan-t5-base-ie_multitask-node-1-acc-consin_rate-1e-4/epoch_32_3225.bin\
        --num_workers 1 \
        --backbone ${backbone} \
        --output $output ${@:2} \
        --num_beams 1\
        ...
        --use_tasks_prompts \
        --eval_tasks "relation_mnre_v2, relation_mnre_v1" \
